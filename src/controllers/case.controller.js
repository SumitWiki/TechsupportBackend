...
<head>
<meta charset="UTF-8" />
<title>TechSupport4 Ticket</title>
</head>
<body style="margin:0;padding:0;background-color:#0f172a;font-family:Arial, sans-serif;color:#ffffff;">

<table width="100%" cellpadding="0" cellspacing="0">
<tr>
<td align="center">

<table width="600" cellpadding="0" cellspacing="0" style="background:#111827;border-radius:10px;overflow:hidden;">

<tr>
<td style="background:linear-gradient(90deg,#2563eb,#7c3aed);padding:25px;text-align:center;">
<h1 style="margin:0;color:#fff;">TechSupport4</h1>
<p style="margin:5px 0 0 0;color:#e0e7ff;">Remote Tech Support – USA, UK & Canada</p>
</td>
</tr>
...
<h2 style="color:#ffffff;margin-top:0;">We've Received Your Request ✅</h2>

<p>Hi <strong>${esc(name)}</strong>,</p>

<p>
Thank you for contacting TechSupport4.  
Our certified technicians will review your request and get back to you within <strong>30–60 minutes</strong>.
</p>

<div style="background:#1f2937;padding:20px;border-radius:8px;text-align:center;margin:25px 0;">
<p style="margin:0;font-size:14px;color:#9ca3af;">YOUR CASE REFERENCE NUMBER</p>
<h2 style="margin:10px 0;color:#60a5fa;letter-spacing:2px;">
${esc(caseId)}
</h2>
...
<table width="100%" cellpadding="8" cellspacing="0" style="background:#1f2937;border-radius:8px;">
<tr><td><strong>Name:</strong></td><td>${esc(name)}</td></tr>
<tr><td><strong>Email:</strong></td><td>${esc(email)}</td></tr>
<tr><td><strong>Phone:</strong></td><td>${esc(phone)}</td></tr>
<tr><td><strong>Issue:</strong></td><td>${esc(message)}</td></tr>
</table>

<p style="margin-top:30px;">
If you need <strong>immediate assistance</strong>, call us directly:
</p>

<div style="text-align:center;margin:20px 0;">
<a href="tel:${process.env.PHONE_USA}"
style="background:#2563eb;color:#fff;padding:12px 25px;text-decoration:none;border-radius:6px;font-weight:bold;">
📞 Call USA: ${process.env.PHONE_DISPLAY}
</a>
</div>
...
<tr>
<td style="background:#0b1220;padding:15px;text-align:center;font-size:12px;color:#9ca3af;">
